...
def PY400C(Figure, Axes, MagRemBool = False, CoercField = False):
    ...
    data_folder = Path("C:\\Users\\lenovo\\Documents\\Verkfræðileg eðlisfræði HÍ\\Vorönn 2020\\Verklegt\\MOKE\\PY_MgO_400C")

    start = time.time()
    counter = 0
    for degrees in Deg:
        #specify the name of the file
        string1 = "Py_MgO_400C_"
        string2 = str(degrees)
        string3 = "-Deg_avg.txt"
        ...
        Info, AllData = MK.DataSetup(Content, "Py_MgO_400C", degrees)
        ...
        leftSwitch, rightSwitch, Coercivity = MK.MokeCoercivity(AllData,"PY_MgO_400C",plotting=True)
    ...
    ax.set_title("Coercivity for Py_MgO_400C")
    plt.savefig("Py_MgO_400C_Coercivity.png",format="png",dpi=300)
    ...
    ax1.set_rmax(1)
    ax1.set_rmin(0.82)
    ax1.set_title("Magnetic Remanence for Py_MgO_400C")
    plt.savefig("Py_MgO_400C_MagRem.png",format="png",dpi=300)
    ...
    ax2.set_rmax(1.1)
    ax2.set_rmin(0)
    ax2.set_title("Magnetic Remanence for Py_MgO_400C")
    plt.savefig("Py_MgO_400C_MagRem_ZeroToOne.png",format="png",dpi=300)
    ...
    #ax3.legend()
    plt.savefig("Py_MgO_400C_CoerciveFieldLeftRight.png",format="png",dpi=300)
    plt.close(fig)
    plt.close(fig1)
    plt.close(fig2)
    plt.close(fig3)
