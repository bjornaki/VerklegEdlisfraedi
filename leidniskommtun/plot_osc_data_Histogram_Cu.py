...
def Cu(fig=None, PlotSelect=None, Vz=None, axes1=None, axes2=None, axes3=None,axesNo=0, fig4 = None):
    ...
    def fig4(axes1=axes1,axes2=axes2,axes3=axes3,axSelect = axesNo,fig4 = fig4):
        ...
        ax2.hist(TOT_G/G0, bins=bins, range=binrange, align='right',edgecolor='b',alpha=0.7)
        ...
        for n in range(1, 8):
            ax2.plot([n, n], [0, 1000], 'r--')

        ax2.axis([-0.5, 8, 0, 1000])

        ax2.text(1.1,800,"B",size=24)
        ax2.set_xticks([0,1,2,3,4,5,6,7,8])
        ax2.tick_params(right=True,top=True,direction='in',labelsize=20,size=14)
